<div>
    <div class="mb-3">
        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#irProjectModal">
            + Add IR Project
        </button>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="irProjectModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Intramural Research Project</h5>
