...
use App\Models\IRProject;
use App\Models\FacultyInfo;
use Illuminate\Support\Facades\Auth;

class IRProjectsManager extends Component
{
    public $projects = [];
    ...
    public function addProject()
    {
        ...
        $this->status = 'Applied';
        $this->loadProjects();
        $this->dispatchBrowserEvent('project-added', ['message' => 'IR Project added successfully!']);
    }

    public function removeProject($projectId)
    {
        IRProject::where('id', $projectId)->where('user_id', Auth::id())->delete();
        $this->loadProjects();
        $this->dispatchBrowserEvent('project-removed', ['message' => 'IR Project removed successfully!']);
    }

    public function loadProjects()
    {
        $this->projects = IRProject::where('faculty_info_id', $this->facultyInfoId)
    ...
    {
        return view('livewire.i-r-projects-manager');
    }
}